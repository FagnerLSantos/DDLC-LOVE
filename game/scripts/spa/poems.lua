...
function poem(poemname)
	...
	if poemname == 'poem_y1' then
		...
		poemtext = {
			...
			'Se iluminan, bajo el resplandor ambarino, los rizos de mi',
            'cabello.',
			'Bañándose.',
			'Debe ser esta.',
			'La última farola que ha resistido el paso del tiempo.',
			'La última en ser sustituida por el enfermizo tono azul ',
            'verdoso del futuro.',
			'Me baño. Calma; respiro el aire del presente, pero vivo en ',
            'el pasado.',
			'La luz parpadea.',
	...
	elseif poemname == 'poem_y2' then
		...
		poemtext = {
			...
			'Ocurrió a medianoche, mientras cortaba pan en rodajas para ',
            'picotear.',
			'Un gruñido llamó mi atención. Había un mapache tras la ',
            'ventana.',
			'Creo que fue la primera vez que noté mis insólitas tendencias.',
			'Le di al mapache un trozo de pan, siendo, en el fondo, ',
            'consciente de las consecuencias.',
			'Consciente de que un mapache que es alimentado siempre ',
            'vuelve a por más.',
			...
			'O quizá estoy proyectando mis emociones en el animal ',
            'nuevamente satisfecho.','',

			'El mapache ha empezado a seguirme.',
			'Podría decirse que nos hemos habituado el uno al otro.',
			'El mapache tiene hambre cada vez con más frecuencia, así ',
            'que mi pan siempre está a mano.',
			'Cuando blando mi cuchillo, el mapache muestra su entusiasmo.',
			'Un torrente de sangre. Condicionamiento clásico de Pavlov. ',
            'Corto el pan.',
	...
	elseif poemname == 'poem_y3' then
		...
		poemtext = {
			...
			'Donde el vientre de la tierra emerge caóticamente a la ',
            'superficie.',
			...
			'Una solo puede hacer un castillo de arena donde la arena ',
            'está húmeda.',
			'Pero allí donde la arena está húmeda, viene la marea.',
			'¿Lamerá esta tus cimientos suavemente hasta que te des ',
            'por vencido?',
			'¿O te derribará en un abrir y cerrar de ojos una ola ',
            'repentina?',
			...
			'Hundo mis dedos en la última frontera, tentada por los ',
            'espumosos tentáculos.',
			'Me doy la vuelta, y abandono mi paz en la orilla, a merced ',
            'de la erosión.',
	...
	elseif poemname == 'poem_y3b' then
		...
		poemtext = {
			...
			'Una solitaria figura atraviesa su camino –una silueta que ',
            'obstruye el misterioso brillo.',
			'Mi corazón late con fuerza. La silueta crece. Más cerca. ',
            'Más cerca.',
			'Abro mi paraguas, invocando una sombra para que me oculte.',
			'Pero es demasiado tarde.',
			'Él avanza hacia la farola. Grito y tiro mi paraguas.',
			'La luz parpadea. Mi corazón late con fuerza. Él sube su ',
            'brazo.','',

			'El tiempo se para.','',

			'Lo único que delata su movimiento es el parpadeo de la luz ',
            'ambarina en su largo brazo.',
			'La luz parpadea al ritmo de los latidos de mi corazón,',
			'incitándome a sucumbir ante esta emoción prohibida.',
			'¿Alguna vez has oído hablar de una sensación de calidez ',
            'fantasmal?',
	...
	elseif poemname == 'poem_y22' then
		...
		poemtext = {
			...
			'Un engranaje que gira. Sobre su eje. Triturando. La cabeza ',
            'de un tornillo. Engranajes en línea. Cielo que cae. Siete ',
            'estacas sagradas. Un barco amarrado. Un portal a otro mundo. ',
            'Una cuerda fina unida a una cuerda gruesa. Un cinturón roto. ',
            'Engranajes parabólicos. Universo en expansión. Tiempo ',
            'controlado por el deslizar de unas ruedas dentadas. ',
            'Existencia de Dios. Nadando en mar abierto en todas las ',
            'direcciones. Ahogándose. Una plegaria escrita en sangre. ',
            'Una plegaria escrita en serpientes devoradoras de tiempo ',
            'con ojos humanos. Una trama conectando todos los ojos de ',
            'los humanos vivos. Un calidoscopio de serpientes sagradas. ',
            'Engranajes exponenciales. Un cielo de estrellas explotando. ',
            'Dios disconforme con la existencia de Dios. Un engranaje ',
            'rotando en seis dimensiones. Cuarenta engranajes y un reloj ',
            'que hace tic-tac. Un reloj que suena cada segundo. La ',
            'cabeza de un tornillo de estacas sagradas atadas a la ',
            'existencia de un barco amarrado a otro mundo. Un ',
            'caleidoscopio de sangre escrita en relojes. Una plegaria ',
            'devoradora de tiempo conectando un cielo de cuarenta ',
            'engranajes y ojos humanos abiertos en todas direcciones. ',
            'Engranajes que respiran. Cabeza de tornillo que respira. ',
            'Barco que respira. Portal que respira. Serpientes que ',
            'respiran. Dios que respira. Sangre que respira. Estacas ',
            'sagradas que respiran. Ojos humanos que respiran. Tiempo ',
            'que respira. Plegaria que respira. Cielo que respira. ',
            'Engranaje que respira.'}
...
4oCmIG5vIHB1ZWRvIHBhcmFybWUu]]};
	...
	elseif poemname == 'poem_n23' then
		...
		poemtext = {
			...
			'sé qué hacer. Creo que ella solo te escuchará a ti. No sé ',
            'por qué. Pero, por favor, intenta hacer algo. A lo mejor ',
            'puedes convencerla para que vaya a terapia. ','',
	...
	elseif poemname == 'poem_s1' then
		...
		poemtext = {
			...
			'La forma en que brillas a través de mis cortinas por la ',
            'mañana hace que sienta que me has echado de menos.',
	...
	elseif poemname == 'poem_s2' then
		...
		poemtext = {
			...
			'Pequeñas esferas de luz solar, acurrucadas como una ',
            'camada de gatitos.',
			'Introduzco mi pulgar y mi índice y extraigo una.',
			'Está calentita y hace cosquillas.',
			'¡Pero no hay tiempo que perder! La pongo en una botella ',
            'para mantenerla a salvo.',
			'Y pongo la botella en la estantería con todas las demás ',
            'botellas.',
			'Pensamientos felices, pensamientos felices, pensamientos ',
            'felices en botellas, todos en fila.','',
			...
			'Como si explorasen una cueva oscura, descubren los ',
            'secretos escondidos',
			...
			'Mis amigos miran a través de mi puerta principal, que está ',
            'bloqueada.',
			...
			'Pero cada vez que dejo a una marchar, se hace añicos en la ',
            'baldosa que hay entre mis pies.',
			'Pensamientos felices, pensamientos felices, pensamientos ',
            'felices en pedazos, por todo el suelo.','',

			'Tenían que haber sido para mis amigos, mis amigos que no ',
            'están sonriendo.',
	...
	elseif poemname == 'poem_s3' then
		...
		poemtext = {
			...
			'Mi.',
			'Cabeza.','',
			'Sal de mi cabeza antes de que haga lo que sé que es mejor ',
            'para ti.',
			'Sal de mi cabeza antes de que haga caso de todo lo que ella ',
            'me dijo.',
			'Sal de mi cabeza antes de que te demuestre lo mucho que ',
            'te quiero.',
			'Sal de mi cabeza antes de que termine de escribir este ',
            'poema.',
			'','','','','','','','','',
	...
	elseif poemname == 'poem_m1' then
		...
		poemtext = {
			...
			'¿Un vecino ruidoso? ¿Un novio enfadado? Nunca lo sabré. ',
            'Yo no estaba en casa.',
			'Miro hacia dentro, en busca de una pista.',
			'¡No! No puedo ver nada. Ciega, me tambaleo como una cinta ',
            'dejada al sol.',
			'Pero es demasiado tarde. Mis retinas.',
			'Quemadas ya con una copia permanente de una imagen ',
            'vacua.',
	...
	elseif poemname == 'poem_m22' then
		...
		poemtext = {
			...
			'          Como tocar un CUCHILLO en una CAJA TORÁCICA ',
            '          QUE RESPIRA.',
			'Un p em ',
			' nf nito',
			'sin se tid  ','','','','','','','','','','','','','','',
	...
	elseif poemname == 'poem_m3' then
		...
		poemtext = {
			...
			'Cuenta una antigua leyenda que una dama deambula por la ',
            'Tierra.',
			'La dama que todo lo sabe.',
			...
			'todo lo que queda es la leyenda – última estrella moribunda ',
            'que al atardecer suspira.','',
			...
			'Antes de que separe mis labios, ella me responde con su voz ',
            'hueca.',
			...
			'Y con una exhalación, me devuelve a flote, y me elevo sobre ',
	...
	elseif poemname == 'poem_m4' then
		...
		poemtext = {
			...
			'Con un trazo de su bolígrafo, los perdidos encuentran su ',
            'camino.',
			'En un mundo de infinitas opciones, contempla este día ',
            'especial.','',
