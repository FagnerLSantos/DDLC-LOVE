...
function poem(poemname)
	...
	if poemname == 'poem_y1' then
		...
		poemtext = {
			...
			'Bathing.',
			'It must be this one.',
			'The last remaining streetlight to have withstood the test of ',
            'time. the last yet to be replaced by the sickening blue-green ',
            'hue of the future.',
			'I bathe. Calm; breathing air of the present but living in the ',
            'past.',
			'The light flickers.',
			'I flicker back.'};
	...
	elseif poemname == 'poem_y2' then
		...
		poemtext = {
			...
			'It happened in the dead of night while I was slicing bread ',
            'for a guilty snack.',
			'My attention was caught by the scuttering of a raccoon ',
            'outside my window.',
			'That was, I believe, the first time I noticed my strange ',
            'tendencies as an unordinary human.',
			'I gave the raccoon a piece of bread, my subconscious well ',
            'aware of the consequences.',
			'Well aware that a raccoon that is fed will always come back ',
            'for more.',
			'The enticing beauty of my cutting knife was the symptom.',
			'The bread, my hungry curiosity.',
			'The raccoon, an urge.','',
			
			'The moon increments its phase and reflects that much more ',
            'light off of my cutting',
			'knife.',
			'The very same light that glistens in the eyes of my raccoon ',
            'friend.',
			'I slice the bread, fresh and soft. The raccoon becomes ',
            'excited.',
			'Or perhaps I\'m merely projecting my emotions onto the ',
            'newly-satisfied animal.','',
			
			'The raccoon has taken to following me.',
			'You could say that we\'ve gotten quite used to each other.',
			'The raccoon becomes hungry more and more frequently, so ',
            'my bread is always handy.',
			'Every time I brandish my cutting knife, the raccoon shows ',
            'me its excitement.',
			'A rush of blood. Classic Pavlovian conditioning. I slice the ',
            'bread.',
	...
	elseif poemname == 'poem_y3' then
		...
		poemtext = {
			...
			'Or will a sudden wave send you crashing down in the blink ',
            'of an eye?',
			...
			'I sink my toes into the ultimate boundary line, tempted by ',
            'the foamy',
			'tendrils.',
	...
	elseif poemname == 'poem_y3b' then
		...
		poemtext = {
			...
			'A lone figure crosses its path - a silhouette obstructing ',
            'the eerie glow.',
			'My heart pounds. The silhouette grows. Closer. Closer.',
			'I open my umbrella, casting a shadow to shield me from ',
            'visibility.',
			'But I am too late.',
			...
			'The only indication of movement is the amber light ',
            'flickering against his outstretched arm.',
			'The flickering light is in rhythm with the pounding of my ',
            'heart.',
	...
	elseif poemname == 'poem_y22' then
		...
		poemtext = {
			...
			'A rotating wheel. Turning an axle. Grinding. Bolthead. ',
            'Linear gearbox. Falling sky. Seven holy stakes. A docked ',
            'ship. A portal to another world. A thin rope tied to a thick ',
            'rope. A torn harness. Parabolic gearbox. Expanding universe. ',
            'Time controlled by slipping cogwheels. Existence of God. ',
            'Swimming with open water in all directions. Drowning. A ',
            'prayer written in blood. A prayer written in time-devouring ',
            'snakes with human eyes. A thread connecting all living human ',
            'eyes. A kaleidoscope of holy stakes. Exponential gearbox. A ',
            'sky of exploding stars. God disproving the existence of God.',
			'A wheel rotating in six dimensions. Forty gears and a ',
            'ticking clock. A clock that ticks one second for every ',
            'rotation of the planet. A clock that ticks forty times every ',
            'time it ticks every second time. A bolthead of holy stakes ',
            'tied to the existence of a docked ship to another world. A ',
            'kaleidoscope of blood written in clocks. A time-devouring ',
            'prayer connecting a sky of forty gears and open human eyes',
			'in all directions. Breathing gearbox. Breathing bolthead. ',
            'Breathing ship. Breathing portal. Breathing snakes. ',
            'Breathing God. Breathing blood. Breathing holy stakes.',
			'Breathing human eyes. Breathing time. Breathing prayer. ',
            'Breathing sky. Breathing wheel.'}
	...
	elseif poemname == 'poem_n2' then
		...
		poemtext = {
			...
			'Every time she sang the chorus, my heart would pound to ',
...
b3AgbXlzZWxmLg==]]};
	...
	elseif poemname == 'poem_n23' then
		...
		poemtext = {
            ...
            'something I\'ve been worried about. Yuri has been acting ',
            'kind of strange lately. You\'ve only been here a few days, ',
            'so you may not know what I mean. But she\'s not normally ',
            'like this. She\'s always been quiet and polite and ',
            'attentive...things like that.','',

			'Okay... This is really embarrassing, but I\'m forcing myself ',
            'to suck it up. The truth is, I\'m REALLY worried about her. ',
            'But if I try talking to her, she\'ll just get mad at me ',
            'again. I don\'t know what to do. I think you\'re the only ',
            'person that she\'ll listen to. I don\'t know why. But please ',
            'try to do something. Maybe you can convince her to talk to ',
            'a therapist.','',
			
			'I\'ve always wanted to try being better friends with Yuri, ',
            'and it really hurts me to see this happening. I know I\'m ',
            'going to hate myself later for admitting that, but right ',
            'now I don\'t care. I just feel so helpless. So please see ',
            'if you can do something to help. I don\'t want anything bad ',
            'to happen to her. I\'ll make you cupcakes if I have to. ',
            'Just please try to do something.','',

			'As for Monika... I don\'t know why, but she\'s been really ',
            'dismissive about this. It\'s like she just wants us to ',
            'ignore it. So I\'m mad at her right now, and that\'s why I\'m ',
            'coming to you about this. DON\'T LET HER KNOW I WROTE ',
            'THIS!!!! Just pretend like I gave you a really good poem, ',
            'okay? I\'m counting on you. Thanks for reading.'};
	...
	elseif poemname == 'poem_s2' then
		...
		poemtext = {
			...
			'Little balls of sunshine, all rubbing together like a bundle ',
            'of kittens.',
			'I reach inside with my thumb and forefinger and pluck one ',
            'out.',
			'It\'s warm and tingly.',
			'But there\'s no time to waste! I put it in a bottle to keep ',
            'it safe.',
			'And I put the bottle on the shelf with all of the other ',
            'bottles.',
			...
			'Like exploring a dark cave, discovering the secrets hiding ',
			...
			'In they come, in such a hurry. Do they want my bottles that ',
            'much?',
			'I frantically pull them from the shelf, one after the other.',
			'Holding them out to each and every friend.',
			'Each and every bottle.',
			'But every time I let one go, it shatters against the tile ',
            'between my feet.',
			'Happy thoughts, happy thoughts, happy thoughts in shards, ',
            'all over the floor.','',
			
			'They were supposed to be for my friends, my friends who ',
            'aren\'t smiling.',
	...
	elseif poemname == 'poem_s3' then
		...
		poemtext = {
			...
			'Get out of my head before I listen to everything she said ',
            'to me.',
	...
	elseif poemname == 'poem_m1' then
		...
		poemtext = {
			...
			'A noisy neighbor? An angry boyfriend? I\'ll never know. I ',
            'wasn\'t home.',
			'I peer inside for a clue.',
			'No! I can\'t see. I reel, blind, like a film left out in the sun.',
			'But it\'s too late. My retinas.',
			'Already scorched with a permanent copy of the meaningless ',
            'image.',
	...
	elseif poemname == 'poem_m3' then
		...
		poemtext = {
			...
			'The legend is all that remains - the last dim star ',
            'glimmering in the twilit sky.','',
			...
			'And with a breath, she blows me back afloat, and I pick up ',
            'a gust of wind.'};
